  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto flex min-h-64 w-full max-w-9xl flex-col items-center justify-center px-4 py-8 text-center sm:min-h-72 sm:px-8 md:min-h-80 lg:px-10">
        <p className="rounded-full bg-white/10 px-12 py-3 text-xs font-semibold uppercase text-white sm:text-sm">
          What We Do
        </p>
        <h1 className="mt-5 text-2xl font-bold text-white sm:text4xl md:text-[56px] md:leading-[1.08]">
